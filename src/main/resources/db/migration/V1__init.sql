...
create table users (id bigint generated by default as identity, email varchar(255), enabled bit default true not null, locked bit default false not null, password varchar(255), phone varchar(255), role varchar(255), username varchar(255), primary key (id))
